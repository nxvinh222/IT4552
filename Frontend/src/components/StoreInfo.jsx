                    ...
                    <div className="product-content product-wrap clearfix product-detail">
                        <div className="row">
                            ...
                            <div className="col-md-6 col-md-offset-1 col-sm-12 col-xs-12">
                                ...
                                <hr />
                                <a href="https://www.facebook.com/tatuan19"><button type="button" className="btn btn-dark"><span><i className="fas fa-phone-alt" /></span>Liên hệ<span className="text-bold font18 pl-2">0981524316</span></button></a>
                                <div><span><i className="far fa-clock" /></span>Người quản lý : {this.state.shop.manager_name}</div>
                                <div><span><i className="fas fa-phone-alt"></i></span>Số điện thoại quản lý: {this.state.shop.manager_phone}</div>
                                {/* <hr /> */}
                                {/* <div className="row">
